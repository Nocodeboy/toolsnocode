...
<p style="margin:24px 0 0;color:#8a8a8e;font-size:12px;">You are getting this because you confirmed your subscription at toolsnocode.com. <a href="${esc(unsub)}" style="color:#8a8a8e;">Unsubscribe</a>.</p>`;
}
